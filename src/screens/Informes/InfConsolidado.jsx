...
import { informesConsolidado,resetInforme } from '../../reducers/slices/informeSlice';
...
const InfConsolidado = () => {
    ...
    const submitHandle = () => {  
        ...
        dispatch(informesConsolidado(item)) 
    ...
    return ( 
        <>
         <div className="h-600 flex flex-col border-2">
            ...
            <Consolidado usu={pusers} desde={value1} hasta={value2}/>
            </div>

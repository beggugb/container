...
import { informesAsistencia,resetInforme } from '../../reducers/slices/informeSlice';
...
const InfAsistencias = () => {
    ...
    const submitHandle = () => {  
        ...
        dispatch(informesAsistencia(item))   
    ...
    return ( 
        <>
         <div className="h-600 flex flex-col border-2">
            ...
            <Asistencia desde={value1} hasta={value2}/>
            </div>

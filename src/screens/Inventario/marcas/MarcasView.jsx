...
import { resetData, marcasData,marcasDelete, marcasUpdate, marcasCreate, resetItem } from '../../../reducers/slices/marcaSlice'
...
const MarcasView = () =>{
    ...
    const { data, total, pagina, paginas, loading } = useSelector(state => state.marca)     
    ...
    const handleDelete = (pky) =>{     
        dispatch(marcasDelete({categoriaId:pky})) 
    }   
    ...
    const submitHandle = event =>{               
        ...
        if(nitem.id){            
            dispatch(marcasUpdate(nitem)) 
        }else{            
            dispatch(marcasCreate(nitem)) 
        }
      handleClear()
    }

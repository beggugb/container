...
import { resetData, volumenesData,volumenesDelete, volumenesUpdate, volumenesCreate, resetItem } from '../../../reducers/slices/volumenSlice'
...
const VolumenesView = () =>{
    ...
    const { data, total, pagina, paginas, loading } = useSelector(state => state.volumen)     
    ...
    const handleDelete = (pky) =>{     
        dispatch(volumenesDelete({volumenId:pky})) 
    }   
    ...
    const submitHandle = event =>{               
        ...
        if(nitem.id){            
            dispatch(volumenesUpdate(nitem)) 
        }else{            
            dispatch(volumenesCreate(nitem)) 
        }
      handleClear()
    }

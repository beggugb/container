...
import { resetData, unidadesData,unidadesDelete, unidadesUpdate, unidadesCreate, resetItem } from '../../../reducers/slices/unidadSlice'
...
const UnidadesView = () =>{
    ...
    const { data, total, pagina, paginas, loading } = useSelector(state => state.unidad)     
    ...
    const handleDelete = (pky) =>{     
        dispatch(unidadesDelete({unidadId:pky})) 
    }   
    ...
    const submitHandle = event =>{               
        ...
        if(nitem.id){            
            dispatch(unidadesUpdate(nitem)) 
        }else{            
            dispatch(unidadesCreate(nitem)) 
        }
      handleClear()
    }

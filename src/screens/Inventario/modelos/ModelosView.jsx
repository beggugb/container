...
import { resetData, modelosData,modelosDelete, modelosUpdate, modelosCreate, resetItem } from '../../../reducers/slices/modeloSlice'
...
const ModelosView = () =>{
    ...
    const { data, total, pagina, paginas, loading } = useSelector(state => state.modelo)     
    ...
    const handleDelete = (pky) =>{     
        dispatch(modelosDelete({modeloId:pky})) 
    }   
    ...
    const submitHandle = event =>{               
        ...
        if(nitem.id){            
            dispatch(modelosUpdate(nitem)) 
        }else{            
            dispatch(modelosCreate(nitem)) 
        }
      handleClear()
    }

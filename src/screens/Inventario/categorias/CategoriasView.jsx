...
import { resetData, categoriasData,categoriasDelete, categoriasUpdate, categoriasCreate, resetItem } from '../../../reducers/slices/categoriaSlice'
...
const CategoriasView = () =>{
    ...
    const { data, total, pagina, paginas, loading } = useSelector(state => state.categoria)     
    ...
    const handleDelete = (pky) =>{     
        dispatch(categoriasDelete({categoriaId:pky})) 
    }   
    ...
    const submitHandle = event =>{               
        ...
        if(nitem.id){            
            dispatch(categoriasUpdate(nitem)) 
        }else{            
            dispatch(categoriasCreate(nitem)) 
        }
      handleClear()
    }

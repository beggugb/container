...
import { informesCompras,resetInforme } from '../../reducers/slices/informeSlice';
import Compras from '../Informes/Compras'
...
const RepCompras = () => {
    ...
    const {loading,items }= useSelector(state => state.usuario)  
        ...
        <>        
         ...
         <div className='h-8 flex border w-full text-[13px] font-bold '>
            ...
            <div className='h-550 flex border w-full bg-gray-200'>
                <Compras desde={value1} hasta={value2}/>
            </div>

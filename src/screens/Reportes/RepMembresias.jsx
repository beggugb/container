        ...
        <div className="h-600 flex bg-white flex-col border-2">
            ...
            <div className='h-14 border-b-4 border-gray-300 flex w-full bg-gray-50 pl-10 pr-4'>
                ...
                <div className='w-3/12 flex items-center pr-2'>
                    <label htmlFor='usuarioId' className='h-8 text-[12px] w-1/5 p-2 text-gray-500 font-bold'> Usuario</label>    
                        <div className='w-4/5 flex pl-1'>
                            <SelectData
                            options={items}
                            option={puserId}
                ...
                <button 
                    onClick={()=> setptipo("%")}
                    className={ptipo === '%' ? ' rounded-l-md h-8 w-4/12  text-gray-100 flex border-gray-300 bg-sky-400 justify-center items-center font-bold': 'h-8 w-4/12 flex border-gray-300 justify-center items-center text-gray-600 bg-gray-200 rounded-l-md'}>
                        todos
                    </button> 
                    <button 
                    onClick={()=> setptipo("efectivo")}
                    className={ptipo === 'efectivo' ? ' h-8 w-4/12  text-gray-100 flex border-gray-300 bg-sky-400 justify-center items-center font-bold border-r': 'h-8 w-4/12 flex border-r border-gray-300 justify-center items-center text-gray-600 bg-gray-200'}>
                        efectivo
                    </button>  
                    <button 
                    onClick={()=> setptipo("qr")}
                    className={ptipo === 'qr' ? 'rounded-r-md h-8 w-4/12  text-gray-100 flex  bg-sky-400 justify-center items-center font-bold': 'h-8 w-4/12  flex justify-center items-center text-gray-600 bg-gray-200 rounded-r-md'}>
                       QR
                    </button>   
                </div>
